...
export default function Footer() {
  return (
    <footer className="bg-[#1e1e24] text-white pt-16 mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              {/* Updated Home Link with Smooth Scroll */}
              <Link 
                href="/" 
                onClick={(e) => {
                  // If the user is already on the homepage, prevent a hard reload and just scroll up smoothly!
                  if (window.location.pathname === '/') {
                    e.preventDefault();
                    window.scrollTo({ top: 0, behavior: 'smooth' });
                  }
                }}
                className="text-[#FF7B29] text-sm hover:text-white transition-colors"
              >
                Home
              </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-[#FF7B29] text-sm">
              ...
              {/* Phone  */}
              <a href="tel:+2131231231222" className="flex items-center gap-3 hover:text-white transition-colors">
              ...
              {/* Email  */}
              <a href="mailto:Hikingseekers@gmail.com" className="flex items-center gap-3 hover:text-white transition-colors">
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
              ...
              {/* Location  */}
              <a href="https://share.google/VZZh63IDj6OFllP5I" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors">
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
